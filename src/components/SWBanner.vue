<template>
	<div v-if="offlineReady || needRefresh" class="fixed bottom-0 inset-x-0 pb-2 sm:pb-5 z-20">
		<div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
			<div class="p-2 rounded-lg bg-blueGray-600 dark:bg-blueGray-700 shadow-lg sm:p-3">
				<div class="flex items-center justify-between flex-wrap">
					<div class="w-0 flex-1 flex items-center">
						<span class="flex p-2 rounded-lg bg-blueGray-500 dark:bg-blueGray-700">
